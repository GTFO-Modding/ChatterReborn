...
namespace ChatterReborn.Data
{
    public enum ItemType : uint
    {
        ...
        GlowStick_Christmas = GD.Item.CONSUMABLE_GlowStick_Christmas,
        GlowStick_Halloween = GD.Item.CONSUMABLE_GlowStick_Halloween,
        GlowStick_Yellow = GD.Item.CONSUMABLE_GlowStick_Yellow,
